...
const RightSideContent = ({ jobId }) => {
  ...
  return (
    <React.Fragment>
      {jobs.map((jobOverview) => {
      
        <div className="side-bar ms-lg-4" key={jobOverview._id}>
          ...
          <Card className="company-profile mt-4">
            <CardBody className="p-4">
              <div className="text-center">
                ...
                <div className="mt-4">
                  <h6 className="fs-17 mb-1">NextGenJob Technology Pvt.Ltd</h6>
                  ...
                  <div className="d-flex">
                    ...
                    <div className="ms-3">
                      ...
                      <p className="text-muted fs-14 text-break mb-0">
                        www.NextGenJobtechnology.pvt.ltd.com
                      </p>
                    </div>
                  </div>
                </li>
